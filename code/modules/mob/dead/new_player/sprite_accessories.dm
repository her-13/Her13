...
/datum/sprite_accessory
	...
	//<her13-addition>
	var/list/species_allowed = list(HUMAN,PODMAN,HUBMAN,ANGEL)
	//<her13-addition>
...
/datum/sprite_accessory/hair/bald
	name = "Bald"
	icon_state = "bald"
	species_allowed = list(HUMAN, UNATHI, DIONA, PODMAN, HUBMAN,ANGEL)
...
/datum/sprite_accessory/facial_hair/shaved
	...
	icon_state = "bald"
	gender = NEUTER
	species_allowed = list(HUMAN, UNATHI, TAJARAN, SKRELL, VOX, IPC, DIONA, PODMAN, HUBMAN,ANGEL)
