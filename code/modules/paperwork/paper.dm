...
/obj/item/weapon/paper/scroll/village_law
	name = "Законы надела"
	info = "<h>Законы Надела</h> <br><br><i>Законы писаны королевской рукой и ни при каких обстоятельствах не могут быть изменены</i><br><br> Волю короля исполняет и приводит в действие непосредственно староста или, при отсутствии этакого или желании лорда, Лорд <br><br>Следить за порядком - дело каждого жителя! О преступлениях следует докладывать старосте своего надела, но ежели преступление закона свершается прямо пред взором законопослушного человека - он обязан предотвратить это кощунство.Однако же - не стоит убивать нарушителя, какую бы ненависть честный житель надела не питал к нему - нарушителя следует отдать под справедливый суд старосты, сделать из нарушителя пример.<br><hr><b>Воровство</b> — вариативное наказание по мнению старосты. <br> <br> <i>Пояснение</i>: факт воровства должен быть подтвержден обвиняющим<br><hr><b>Драки</b> — 7 минут позорного столба и 5 ударов плеткой виновному.<i></i><br><hr><b>Убийство</b> — конфискация всего имущества (В том числе ключа) и изгнание из города..<br> <br> <i>Пояснение</i>: Перед исполнением приговора, убедиться о том что убийство намеренное.<br><hr><b>Убийство по случайности</b> — 15 минут позорного столба ИЛИ 40 ударов плеткой!<br> <br> <i>Пояснение</i>: Обвиняемый сам должен доказать отсутствие злого умысла. <br><hr><b>Мятеж</b> — смертная казнь<br> <br> <i>Пояснение</i>: смертная казнь производится по указу старосты или лорда.<br><hr><b>Ересь</b> — наказание по усмотрению монаха.<br> <br> <i>Пояснение</i>: смертная казнь производится по указу монаха или лорда.<br><hr><b>Злоупотребление полномочиями</b> — конфискация имущества (в том числе и ключа) и изгнание из города. <br> <br> <i>Пояснение</i>: сюда входит кража денег старостой, подброс улик ополченцем и все в этом духе.<br><hr> <h>Иеахрия</h> <br><br> Староста и рыцари обязаны отвечать лично перед Лордом, деревня находится в распоряжении старосты, а монастырь, что не является её частью, находится под властью монахов. Просить деньги за свои услуги и товары - право каждого жителя."
