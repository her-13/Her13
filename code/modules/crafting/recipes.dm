...
/datum/crafting_recipe/can_grenade_igniter
	...
	parts = list(/obj/item/weapon/reagent_containers/food/drinks/cans = 1,
				/obj/item/stack/cable_coil = 1)
	time = 40
	required_proficiency = /datum/skill/construction/trained
...
/datum/crafting_recipe/can_grenade_rag
	...
	parts = list(/obj/item/weapon/reagent_containers/food/drinks/cans = 1,
				/obj/item/stack/cable_coil = 1)
	time = 30
	required_proficiency = /datum/skill/construction/novice
...
// Если этого нет в homm_recipes.dm , значит нам это не нужно
